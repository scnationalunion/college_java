package com.hua.college.uploader.service.impl;

import com.hua.college.uploader.dto.FileChunkDTO;
import com.hua.college.uploader.dto.FileChunkResultDTO;
import com.hua.college.uploader.service.IUploadService;
...
public class UploadServiceImpl implements IUploadService {
    ...
    private boolean mergeChunks(String identifier, String filename, Integer totalChunks) {
        logger.info("开始合并分片,文件标识:{},文件名:{}", identifier, filename);
...
//            objectObjectHashMap.put("path", getFileRelativelyPath(chunkDTO.getIdentifier(), chunkDTO.getFilename()));
            ...
            //设置过期
            redisTemplate.expire(chunkDTO.getIdentifier(), 5, TimeUnit.MINUTES);
        }
